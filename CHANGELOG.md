...
- Provide a control to take a map capture [\#225](https://github.com/kalisio/kano/issues/225)
- Layer import : permit to choose default visibility of a new layer [\#207](https://github.com/kalisio/kano/issues/207)

**Fixed bugs:**

- Switching from 2D to 3D activity if a GeoJson layer is visible raises an error [\#169](https://github.com/kalisio/kano/issues/169)
...
[Full Changelog](https://github.com/kalisio/kano/compare/prod-v1.3.1...prod-v1.3.2)
