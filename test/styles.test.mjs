...
describe(`suite:${suite}`, () => {
  ...
  it('2D styles: import styled geojson file', async () => {
    ...
    const match = await runner.captureAndMatch('2D-features-with-style')
  ...
  it('2D styles: realtime pane update', async () => {
    ...
    const match = await runner.captureAndMatch('2D-features-updated-style')
  })
  ...
  it('2D styles: import geojson file with panes', async () => {
    ...
    const match = await runner.captureAndMatch('2D-features-with-panes')
  ...
  it('2D styles: realtime pane update', async () => {
    ...
    const match = await runner.captureAndMatch('2D-features-updated-pane')
  })
