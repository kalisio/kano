import{_ as s,c as a,o as n,V as p}from"./chunks/framework.BPkfcHrH.js";const e="/kano/assets/kano-ogc-layers.CY-RdT77.png",i="/kano/assets/kano-file-layers.BV8gOkkz.png",l="/kano/assets/kano-covid-19-layers.Dgrrapdj.png",t="/kano/assets/kano-covid-19-layers-3D.BjxAkZhd.png",o="/kano/assets/kano-sensors-layers.DV9YtHbc.png",b=JSON.parse('{"title":"Customizing Kano","description":"","frontmatter":{"sidebarDepth":3},"headers":[],"relativePath":"guides/customizing-kano.md","filePath":"guides/customizing-kano.md"}'),r={name:"guides/customizing-kano.md"},c=p(`<h1 id="customizing-kano" tabindex="-1">Customizing Kano <a class="header-anchor" href="#customizing-kano" aria-label="Permalink to &quot;Customizing Kano&quot;">​</a></h1><p>This section details different approaches to integrate your own data to your Kano instance. Although you can directly use the Kano UI to add your own data layers this section provide details to do this by configuration or programmatically. When added through the UI, the different layers will be visible in the <em>My data</em> tab of the <a href="./../guides/getting-started.html#catalog">catalog panel</a>, while the default built-in layers will appear in the <em>Catalog</em> tab of the <a href="./../guides/getting-started.html#catalog">catalog panel</a>. You can also manage the <strong>categories</strong> (i.e. catalog sections) hosting the layers from the UI or the configuration.</p><p>Although names and descriptions can be hard-coded in the target user language, Kano supports internationalization through a nested structure organized by locale like this:</p><div class="language-js vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">js</span><pre class="shiki shiki-themes github-light github-dark vp-code"><code><span class="line"><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">{</span></span>
...
<span class="line"><span>    isVisible: false</span></span>
<span class="line"><span>  },</span></span>
<span class="line"><span>  legendUrl: &#39;https://data.geopf.fr/annexes/ressources/legendes/INSEE.FILOSOFI.POPULATION-tot-legend-2017.png&#39;</span></span>
<span class="line"><span>}, {</span></span>
...
<span class="line"><span>      unit: &#39;degC&#39;,</span></span>
